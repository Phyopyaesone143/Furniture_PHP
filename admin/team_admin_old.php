...
<body>
	...
	<?php
		...
		if (isset($sclick)) {
			$cquery = "INSERT INTO team (tname,position,sarlary,image) VALUES('$tname','$position','$sarlary','$image')";
				...
				<div class="modal-content">
					...
					<form action="team_admin.php" method="POST" enctype="multipart/form-data">
						...
						<div class="modal-footer">
							...
							<button type="submit" name="sclick" class="btn btn-primary">Save changes</button>
						</div>
					</form>
				</div>
			</div>
